...
@section('title'){{ trans('message.edit_guest') }}@endsection
@section('head')
<style type="text/css">
    input, select {
        padding: 0 10px;
...
<div class="common_main_wrap">
    <div class="list_wrapper">
        <div class="index_top_block">
            <h1 class="common_page_title">{{ trans('message.edit_guest') }}</h1>
        </div>
                    ...
                    <div class="row col-sm-12">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="account_apply" id="account_apply">
                                ...
                                @php
                                    $selected = data_get($guest, 'account_apply') == $id ? 'selected="selected"' : '';
                                @endphp
